...
pm_caption = "➥ **X-USERBOT IS:** `ONLINE`\n\n"
...
pm_caption += "➥ **Copyright** : By [POWEROFAVENGER@Github](GitHub.com/POWEROFAVENGER)\n"
pm_caption += "➥ **Check Stats By Doing** `.stat`. \n\n"
pm_caption += "[🇮🇳 Deploy X-Userbot 🇮🇳](https://telegra.ph/file/a95fc8464e1124b44ab89.jpg)"
